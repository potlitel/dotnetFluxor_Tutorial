namespace MiddlewareTutorial.Store.Middlewares.Logging
{
    public class LoggingMiddleware : Middleware
    {
        ...
        public override void AfterDispatch(object action)
        {
            ...
            {
                string json = JsonConvert.SerializeObject(feature.Value, Newtonsoft.Json.Formatting.Indented)
                    .Replace("\n", "\n\t");
                Log("\r\n\t" + feature.Key + ": " + json);
            }
            Console.WriteLine();
        ...
        private string ObjectInfo(object obj)
            => ": " + obj.GetType().Name + " " + JsonConvert.SerializeObject(obj, Newtonsoft.Json.Formatting.Indented);
